...
package org.wso2.carbon.identity.policy.consent.internal;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.osgi.service.component.ComponentContext;
import org.wso2.carbon.identity.application.authentication.framework.ApplicationAuthenticator;
import org.wso2.carbon.identity.policy.consent.UserConsentEnforcerOnNoConsent;
import org.wso2.carbon.identity.policy.consent.UserConsentUserOperationListener;
...
/**
 * @scr.component name="org.wso2.carbon.identity.policy.consent.component" immediate="true"
 */
public class PasswordResetEnforcerServiceComponent {
    ...
    protected void activate(ComponentContext ctxt) {
        try {
            ...
            UserConsentEnforcerOnNoConsent authenticator = new UserConsentEnforcerOnNoConsent();
            ...
            ctxt.getBundleContext().registerService(UserOperationEventListener.class.getName(),
                    new UserConsentUserOperationListener(), props);
            if (log.isDebugEnabled()) {
                log.debug("UserConsentEnforcerOnNoConsent handler is activated");
            }
        } catch (Throwable e) {
            log.fatal("Error while activating the UserConsentEnforcerOnNoConsent handler ", e);
        }
    }
    ...
    protected void deactivate(ComponentContext ctxt) {
        if (log.isDebugEnabled()) {
            log.debug("UserConsentEnforcerOnNoConsent is deactivated");
        }
    }
