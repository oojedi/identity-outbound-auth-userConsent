...
/**
 * User Consent authenticator's constants
 */
public class PasswordChangeEnforceConstants {
    public static final String AUTHENTICATOR_NAME = "user-consent-enforcer";
    public static final String AUTHENTICATOR_TYPE = "LOCAL";
    public static final String STATE = "state";
    public static final String SITE_TERMS = "SITE_TERMS";
