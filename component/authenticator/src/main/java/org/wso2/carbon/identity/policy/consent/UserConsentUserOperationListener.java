 ...
 * http://wso2.org/claims/userConsent upon acceptance of the site's terms and conditions.
 */
public class UserConsentUserOperationListener extends AbstractUserOperationEventListener {

    private static Log log = LogFactory.getLog(UserConsentUserOperationListener.class);
    ...
    /**
     * Update current time to lastPasswordChangedTimestamp claim after changing the password by user.
     *
     * @param userName         the user name
     * @param credential       the user's credential
     * @param userStoreManager the user store manager
